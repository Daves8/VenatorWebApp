...
AS
BEGIN
    INSERT INTO DBO.REACTIONS (REACTION_TYPE, TEXTUAL_ID, USER_ID, CREATION_DATE)
	VALUES (@REACTION_TYPE, @TEXTUAL_ID, @USER_ID, GETDATE())
END
GO
...
BEGIN
    SELECT 1
    FROM DBO.REACTIONS
    WHERE TEXTUAL_ID = @TEXTUAL_ID AND USER_ID = @USER_ID AND REACTION_TYPE = @REACTION_TYPE
END
GO
...
BEGIN
	...
	WHERE TEXTUAL_ID = @TEXTUAL_ID AND USER_ID = @USER_ID
END
GO
